...
namespace RedmineServer.WebSocket
{
    public class WebSocketManagerMiddleware
    {
        ...
        public async TaskT Invoke(HttpContext context)
        {
        ...
        private async TaskT Receive(System.Net.WebSockets.WebSocket socket, Action<WebSocketReceiveResult, byte[]> handleMessage)
        {
